...
describe('PGM', () => {
    it('should run rpg program', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(result[0].mynt).to.equal('ISK');
        (0, chai_1.expect)(result[1].mynt).to.equal('EUR');
    })).timeout(15000);
    it('should run GETNETFG', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(result.valid).to.equal('J');
    }));
    it('should run pgm with datastructure param', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(result.p1.txt1).to.equal('tst');
        (0, chai_1.expect)(result.p1.num1).to.equal(401);
        (0, chai_1.expect)(result.p1.num2).to.equal(8);
    }));
    ...
    it('should get timeout errors', () => {
        ...
        return brokenProgram({ strengur: 'abcd123' })
            ...
            .catch((e) => {
            (0, chai_1.expect)(e.category).to.equal('OperationalError');
            (0, chai_1.expect)(e).not.to.equal(null);
            (0, chai_1.expect)(e.message).to.contain('Connection was dropped unexpectedly.');
        });
    });
});
