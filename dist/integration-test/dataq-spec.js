...
describe('keyed dataQ', () => {
    it('should read and write', (done) => {
        ...
        dataQ
            .read('mytestkey')
            .then((data) => {
            (0, chai_1.expect)(data).to.equal('ping');
        })
            .then(done, done);
    ...
    it('should fail on timeout', (done) => {
        ...
        dataQ
            ...
            .catch((err) => {
            (0, chai_1.expect)(err.message).to.contain('timeout, key: mytestkey');
        })
            .then(done, done);
    });
    it('should write to reponse', () => {
        ...
        dataQ
            ...
            .then((res) => {
            (0, chai_1.expect)(res.data).to.equal('ping');
            res.write('pong');
        })
            .catch((err) => {
        ...
        return dataQ.read({ key: 'returnkey  ', wait: 10 }).then((data) => {
            (0, chai_1.expect)(data).to.equal('pong');
        });
    });
});
