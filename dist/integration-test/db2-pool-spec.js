...
describe('jt400 pool', () => {
    ...
    it('should not be in memory', () => {
        (0, chai_1.expect)(db_1.jt400.isInMemory()).to.equal(false);
    });
    it('should not return same instance in configure', () => {
        (0, chai_1.expect)(db_1.jt400).to.not.equal((0, __1.pool)({ host: 'foo' }));
    });
    it('should configure host', () => {
        const db = (0, __1.pool)({ host: 'nohost' });
        return db
            ...
            .catch((err) => {
            (0, chai_1.expect)(err.message).to.include('nohost');
            (0, chai_1.expect)(err.category).to.equal('OperationalError');
        });
    }).timeout(20000);
    it('should insert records', () => {
        (0, chai_1.expect)(idList.length).to.equal(2);
        (0, chai_1.expect)(Number(idList[0])).to.be.above(1);
    });
    ...
    it('should trim values as default', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(data.length).to.equal(2);
        (0, chai_1.expect)(data[1].FOO).to.equal('bar2');
    }));
    ...
    it('should execute update', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, chai_1.expect)(nUpdated).to.equal(1);
    }));
    it('should execute update with parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        const nUpdated = yield db_1.jt400.update('update tsttbl set foo=? where testtblid=?', ['ble', 0]);
        (0, chai_1.expect)(nUpdated).to.equal(0);
    }));
    it('should insert dates and timestamps', () => {
        ...
        return db_1.jt400
            ...
            .then((res) => {
            (0, chai_1.expect)(res[0].FRA).to.eql('2014-01-15');
            (0, chai_1.expect)(res[0].TIMI).to.eql('2014-01-16 15:32:05.000000');
        });
    });
    it('should insert clob', () => __awaiter(void 0, void 0, void 0, function* () {
        const largeText = (0, fs_1.readFileSync)(__dirname + '/../../test-data/clob.txt').toString();
        ...
        (0, chai_1.expect)(res[0].CLOB.length).to.equal(largeText.length);
    })).timeout(20000);
    it('should insert blob', () => __awaiter(void 0, void 0, void 0, function* () {
        const image = (0, fs_1.readFileSync)(__dirname + '/../../test-data/blob.png', {
            encoding: 'base64',
        });
        ...
        (0, chai_1.expect)(res[0].BLOB.length).to.equal(image.length);
    }));
    it('should fail query with oops error', () => {
        ...
        return db_1.jt400
            ...
            .catch((error) => {
            (0, chai_1.expect)(error.message).to.equal('Descriptor index not valid.');
            (0, chai_1.expect)(error.cause.stack).to.include('JdbcJsonClient.setParams');
            (0, chai_1.expect)(error.context.sql).to.equal(sql);
            (0, chai_1.expect)(error.context.params).to.equal(params);
    ...
    it('should fail insert with oops error', () => {
        ...
        return db_1.jt400
            ...
            .catch((error) => {
            (0, chai_1.expect)(error.message).to.equal('[SQL0104] Token TESTTABLE was not valid. Valid tokens: : <INTEGER>.');
            (0, chai_1.expect)(error.cause.stack).to.include('JdbcJsonClient.insertAndGetId');
            (0, chai_1.expect)(error.context.sql).to.equal(sql);
            (0, chai_1.expect)(error.context.params).to.equal(params);
            (0, chai_1.expect)(error.category).to.equal('ProgrammerError');
        });
    ...
    it('should fail execute query with oops-error', () => {
        ...
        return db_1.jt400
            ...
            .catch((error) => {
            (0, chai_1.expect)(error.message).to.equal('[SQL0104] Token - was not valid. Valid tokens: AS CL ID IN TO ASC END FOR KEY LAG LOG NEW OFF OLD OUT COPY DATA.');
            (0, chai_1.expect)(error.context.sql).to.equal(sql);
            (0, chai_1.expect)(error.context.params).to.deep.equal([]);
            (0, chai_1.expect)(error.category).to.equal('ProgrammerError');
        });
    });
